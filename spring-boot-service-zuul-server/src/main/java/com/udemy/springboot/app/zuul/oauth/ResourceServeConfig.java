...
public class ResourceServeConfig extends ResourceServerConfigurerAdapter{
	...
	public CorsConfigurationSource corsConfigurationSource() {		
		//Crear las configuraciones de Cors
		...
		//Pasar las configuraciones de cors a las rutas URL
		UrlBasedCorsConfigurationSource urlBasedCorsConfigurationSource = new UrlBasedCorsConfigurationSource();
		urlBasedCorsConfigurationSource.registerCorsConfiguration("/**", corsConfiguration);
		return urlBasedCorsConfigurationSource;
	}

	//Crear un filtro de cors
	@Bean
	public FilterRegistrationBean<CorsFilter> corsFilter(){
		FilterRegistrationBean<CorsFilter> bean = new FilterRegistrationBean<CorsFilter>(new CorsFilter(corsConfigurationSource()));
		bean.setOrder(Ordered.HIGHEST_PRECEDENCE);//Se la da una prioridad alta
		return bean;
	}
